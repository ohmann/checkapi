...
def download_page(request_dict):
  ...
  # Check the arguments
  error = None
  print str(request_dict["GET_ARGS"]["file"])
...
def main(args):
  ...
  # Upload File for Benchmark Test
  file_data = FILE_DATA_TEST * 64 # 1 Kbyte data
  store_file(FILE_NAME_TEST, file_data) # Upload file
