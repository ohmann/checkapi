...
import checkapi_interposition

def SetStringData_C_Module(string_data):
  return checkapi_interposition.SetStringData(string_data)

def CreateConnectSocket_C_Module():
  return checkapi_interposition.CreateConnectSocket()

def CloseSocket_C_Module():
  return checkapi_interposition.CloseSocket()
...
def main(resourcefn, program, args):
  ...
  usercontext["SetStringData_C_Module"] = SetStringData_C_Module  
  usercontext["CreateConnectSocket_C_Module"] = CreateConnectSocket_C_Module  
  usercontext["CloseSocket_C_Module"] = CloseSocket_C_Module
