...
_NODE_ATTR_OK = []
_STR_OK = ['__init__','__eq__','__ne__','__lt__','__gt__','__dict__','__del__','__iter__', '__setitem__', '__delitem__', 'eval']
_STR_NOT_CONTAIN = ['__']
...
_BUILTIN_OK = [
    ...
    'abs', 'bool', 'cmp', 'complex', 'dict', 'divmod', 'filter', 'float', 'frozenset', 'hex', 'int', 'len', 'list', 'long', 'map', 'max', 'min', 'object', 'oct', 'pow', 'range', 'reduce', 'repr', 'round', 'set', 'slice', 'str', 'sum', 'tuple',  'xrange', 'zip','id', 'eval'
    ]
